...
-(void)maProfileWithModel:(Y_KLineModel *)model
{
    ...
    _VolumeMA7Label.text = [NSString stringWithFormat:@"  MA7：%.8f ",model.Volume_MA7.doubleValue];
    _VolumeMA30Label.text = [NSString stringWithFormat:@"  MA30：%.8f",model.Volume_MA30.doubleValue];
}
